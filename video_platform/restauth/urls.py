...
from .views import (
    ...
    PasswordResetView, PasswordResetConfirmView, CustomPasswordResetConfirmView, CustomPasswordResetCompleteView
)
...
urlpatterns = [
    ...
    re_path(r'^signin/$', LoginView.as_view(), name='rest_login'),
